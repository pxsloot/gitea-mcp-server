...
def validate_pagination(
    ...
    *,
    ...
    Both tool families name the page-size parameter ``limit`` (the Gitea API
    spec uses ``page``/``limit``; synthetic tools use the same names).  The
    rule is identical; *page_size_name* controls the name reported in error
