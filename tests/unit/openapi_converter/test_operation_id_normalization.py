...
class TestOperationIdNormalization:
    ...
    def test_camelcase_operation_id_converted(self) -> None:
    ...
    def test_pascalcase_operation_id_converted(self) -> None:
    ...
    def test_mixed_operation_id_converted(self) -> None:
    ...
    def test_generated_operation_id_is_snake_case(self) -> None:
    ...
    def test_complex_operation_id_with_acronyms(self) -> None:
    ...
    def test_preserves_snake_case_operation_id(self) -> None:
