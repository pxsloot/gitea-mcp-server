...
class TestGiteaClient:
    ...
    def test_should_retry_with_retry_after_header(self) -> None:
    ...
    def test_should_retry_429_without_retry_after(self) -> None:
    ...
    def test_wait_retry_uses_retry_after_when_present(self) -> None:
    ...
    def test_wait_retry_falls_back_to_exponential_when_no_retry_after(self) -> None:
    ...
    def test_should_retry_invalid_retry_after_header(self) -> None:
    ...
    def test_should_retry_httpx_http_status_error(self) -> None:
    ...
    def test_should_retry_gitea_error_with_cause_http_status_error(self) -> None:
    ...
    def test_should_retry_gitea_error_without_cause(self) -> None:
