...
class TestLabelService:
    ...
    def test_stats_empty_cache(self, label_service: LabelService) -> None:
    ...
    @pytest.mark.asyncio
    async def test_clear_cache_for_missing_key_no_error(self, label_service: LabelService) -> None:
