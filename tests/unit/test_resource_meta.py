...
class TestDeriveSizeHintFromSchema:
    ...
    def test_five_properties_is_small(self):
    ...
    def test_six_properties_is_medium(self):
    ...
    def test_twenty_properties_is_medium(self):
    ...
    def test_twenty_one_properties_is_large(self):
    ...
    def test_deeply_nested_is_large(self):
    ...
    def test_ref_schema_has_no_properties(self):
        """Schema that is pure $ref has no countable properties → tiny."""
        schema = {"$ref": "#/components/schemas/User"}
        assert derive_size_hint_from_schema(schema) == SIZE_TINY

    def test_array_of_ref_is_large(self):
...
class TestResourceMeta:
    ...
    def test_for_schema_derives_size_hint(self):
    ...
    def test_for_schema_explicit_size_hint_overrides(self):
    ...
    def test_for_schema_derives_default_detail_from_size_hint(self):
    ...
    def test_for_schema_explicit_default_detail_overrides(self):
    ...
    def test_for_schema_passes_optional_params(self):
