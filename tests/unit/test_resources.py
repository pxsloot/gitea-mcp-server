...
class TestAutoGeneratedResourceDocstring:
    ...
    async def test_docstring_fallback_to_path(self, mock_mcp, mock_gitea_client, mock_registry):
...
class TestRegisterAutoGeneratedSkipUri:
    ...
    async def test_skip_uris_excluded(self, mock_mcp, mock_gitea_client, mock_registry):
        ...
        register_auto_generated_resources(
            mock_mcp, mock_gitea_client, spec, mock_registry,
...
class TestCustomResourceStringResponsePaths:
    ...
    def captured_resources(self, mock_gitea_client_str):
        ...
        register_custom_resources(mcp, mock_gitea_client_str, registry)
        return registered
