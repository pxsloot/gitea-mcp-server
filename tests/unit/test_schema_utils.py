...
class TestSchemaTypeMatches:
    ...
    def test_string_type_matches(self) -> None:
    ...
    def test_list_type_multiple_non_null(self) -> None:
...
class TestGetSchemaType:
    ...
    def test_list_type_picks_first_non_null(self) -> None:
